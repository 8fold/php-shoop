...
trait Associable
{
    ...
    public function hasAt()
    {
        ...
        AssertEquals::applyWith(
            true,
            "boolean",
            0.95 // 0.82 // 0.78 // 0.72 // 0.69 // 0.59 // 0.56 // 0.53
        )->unfoldUsing(
    ...
    public function offsetExists()
    {
        ...
        AssertEquals::applyWith(
            false,
            "boolean",
            2.58 // 1.16 // 1.12 // 0.66 // 0.61 // 0.59 // 0.51 // 0.4
        )->unfoldUsing(
