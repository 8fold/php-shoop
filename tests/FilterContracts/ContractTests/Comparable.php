...
trait Comparable
{
    ...
    public function is()
    {
        ...
        AssertEquals::applyWith(
            false,
            "boolean",
            0.12, // 0.09, // 0.08, // 0.07, // 0.06, // 0.04, // 0.03,
            1
        )->unfoldUsing(
    ...
    public function isGreaterThan()
    {
        ...
        AssertEquals::applyWith(
            true,
            "boolean",
            0.15, // 0.12, // 0.1, // 0.07, // 0.06, // 0.03, // 0.02,
            1
        )->unfoldUsing(
            Shooped::fold(["a" => 1, "b" => 3, "c" => 1])
        ...
        AssertEquals::applyWith(
            true,
            "boolean",
            0.12, // 0.11, // 0.1, // 0.08, // 0.04, // 0.03, // 0.02,
            1
        )->unfoldUsing(
